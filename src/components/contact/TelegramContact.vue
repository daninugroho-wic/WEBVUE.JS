<template>
    <div class="h-full w-full bg-white shadow-lg p-4">
      <h2 class="text-lg font-semibold text-gray-700 mb-4">Contact Telegram</h2>
      
      <!-- Daftar Kontak -->
      <div v-for="(contact, index) in contacts" :key="index" 
           class="flex items-center gap-3 p-3 border-b hover:bg-gray-100 cursor-pointer">
  ...
  const contacts = ref([
    ...
    { name: "Budi Santoso", lastMessage: "Ayo ketemu besok!" }
  ]);
  </script>
